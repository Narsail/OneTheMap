...
public class StudentInformationListGETOperation: ParseServiceOperation {
...
public class StudentInformationGETOperation: ParseServiceOperation {
	...
	private func handleSuccess(response: AnyObject?) {
		do {
			...
			let studentInformationList = try ArrayResponseMapper.process(resultsArray, mapper: StudentInformationResponseMapper.process)
			self.success?(studentInformation: studentInformationList.first)
			self.finish()
		} catch {
			handleFailure(error)
		}
...
public class StudentInformationPOSTOperation: ParseServiceOperation {
...
public class StudentInformationPUTOperation: ParseServiceOperation {
